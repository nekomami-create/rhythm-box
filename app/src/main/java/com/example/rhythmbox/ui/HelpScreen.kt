...
private val helpSections = listOf(
    ...
    HelpSection(
        ...
        listOf(
            ...
            "「ランダム」を押すと、そのパターンのコードと曲の調に沿って旋律を作ります。" +
    ...
    HelpSection(
        "8 小節つくる",
        listOf(
            "右上の ⋮ →「8 小節つくる」で、曲をまるごと作ります。",
            "ジャンルを選ぶ（おまかせも可）と、テンポ・コード進行・リズムを決めて、" +
                "パターン A を 4 小節 + パターン B を 4 小節、という 8 小節の曲構成まで作ります。",
            "旋律には触りません。コードは小節ごとに変わるのに、旋律はパターンに 1 つしか持てないため、" +
                "4 小節を通して合う旋律を自動では作れないからです。作ったあとリードタブで足してください。",
